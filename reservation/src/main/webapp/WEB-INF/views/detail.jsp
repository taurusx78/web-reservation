...
<body>
    <div id="container">
        <div class="ct main">
            <div>
                ...
                <div class="section_btn"> <button type="button" class="bk_btn" onclick="location.href='reserve?id=${param.id}'"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
                <div class="section_review_list">
                    ...
                    <a class="btn_review_more" href="review?id=${param.id}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
    ...
    <script type="rv-template" id="imageNum">
		<span class="num" id="image_num">1</span>
    	<span class="num off">/ <span>{{imageNum}}</span></span>
    </script>
    
    <script type="rv-template" id="productImage">
    	<li class="item" style="width: 414px; height: 414px; line-height: 414px;"> <img alt="" class="img_thumb" src="{{saveFileName}}"> <span class="img_bg"></span>
    ...
    <script type="rv-template" id="slideBtn">
    	<div class="prev">
    		<div class="prev_inn">
    ...
    <script type="rv-template" id="eventInfo">
    	<div class="in_dsc">{{eventInfo}}<br>{{eventContent}} 할인</div>
    </script>
    
    <script type="rv-template" id="reviewSummary">
	    <!-- [D] 별점 graph_value는 퍼센트 환산하여 width 값을 넣어줌 -->
	    <span class="graph_mask"> <em class="graph_value" style="width: {{starRange}}%;"></em> </span>
	    <strong class="text_value"> <span>{{averageScore}}</span> <em class="total">5.0</em> </strong>
	    <span class="join_count"><em class="green">{{commentLength}}건</em> 등록</span>
    </script>
    
    <script type="rv-template" id="reviewContent">
	    <li class="list_item">
	    <div>
	        <div class="review_area" id="review{{number}}">
    ...
    <script type="rv-template" id="thumbImage">
	    <div class="thumb_area">
			<a class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="{{saveFileName}}" alt="리뷰이미지"> </a> <span class="img_count">1</span>
		</div>
    </script>
    
    <script type="rv-template" id="moreInfo">
	...
	<script type="rv-template" id="wayToCome">
