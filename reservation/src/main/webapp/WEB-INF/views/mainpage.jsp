...
<body id="top">
        ...
        <div class="event">
            ...
            <div class="section_event_tab">
                <ul class="event_tab_lst tab_lst_min">
                    <li class="item" data-category="0" id="category_0">
            ...
            <div class="section_event_lst">
                ...
                <div class="wrap_event_box">
                    ...
                    <ul class="lst_event_box" id="left_lst_box">  
                    </ul>
                    <ul class="lst_event_box" id="right_lst_box">
                    </ul>
                    <!-- 더보기 -->
	...
	<script type="rv-template" id="categoryItem">
		<li class="item" data-category={categoryId} id="category_{categoryId}">
